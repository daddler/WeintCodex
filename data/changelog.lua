...
WeintCodex_ChangelogData = {
    {
        ...
        notes   = {
            ...
            "Jetzt wird gewartet, solange die Bestaetigungen steigen, und danach einzeln nachgefasst: erst alle in der urspruenglichen Schreibweise, dann alle in der anderen (mit und ohne Realm-Zusatz).",
